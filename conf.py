# -*- coding: utf-8 -*-
#
# py-services-mdm documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'bitdustdoc.tex', u'BitDust Documentation',
...
man_pages = [
    (master_doc, 'bitdustdoc', u'BitDust Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bitdustdoc', u'BitDust Documentation',
     author, 'bitdustdoc', 'BitDust is a destributed computer network for data storage and safe communications.',
     'Networking'),
]
